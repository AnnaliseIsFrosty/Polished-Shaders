Shader "Custom/HealthbarShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _CrackLength, _CrackStrength, _CrackStart, _PreviousHealth, _LerpedHealth, _HealthLerpSpeed;
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                if (_CrackStart > 0) 
                {
                    ...
                    {
                        _LerpedHealth = lerp(_PreviousHealth, _Health, PolynomialImpulse(1, frac(_Time.y - _CrackStart) * _HealthLerpSpeed));
                    }
